        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Handle = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false, defaultValue: "")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Rating = table.Column<int>(type: "int", nullable: false, defaultValue: 1200),
                    ContestsParticipated = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Statement = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    InputDescription = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OutputDescription = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Problems_AspNetUsers_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CaptainId = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccessCode = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContestParticipants_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContestId = table.Column<int>(type: "int", nullable: false),
                    ProblemId = table.Column<int>(type: "int", nullable: false),
                    ProblemLetter = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Order = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rankings_Contests_ContestId",
                        column: x => x.ContestId,
                        principalTable: "Contests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JudgedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JudgeQueues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JudgeQueues_Submissions_SubmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContestParticipants_ContestId_TotalScore_PenaltyTime",
                table: "ContestParticipants",
                columns: new[] { "ContestId", "TotalScore", "PenaltyTime" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContestParticipants_TeamId",
                table: "ContestParticipants",
                column: "TeamId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Discussions_UpdatedAt",
                table: "Discussions",
                column: "UpdatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_JudgeQueues_Priority",
                table: "JudgeQueues",
                column: "Priority");

            migrationBuilder.CreateIndex(
                name: "IX_JudgeQueues_QueuedAt",
                table: "JudgeQueues",
                column: "QueuedAt");

            migrationBuilder.CreateIndex(
                name: "IX_JudgeQueues_Status",
                table: "JudgeQueues",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_JudgeQueues_SubmissionId",
                table: "JudgeQueues",
                column: "SubmissionId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProblemTags_ProblemId_Name",
                table: "ProblemTags",
                columns: new[] { "ProblemId", "Name" });

            migrationBuilder.CreateIndex(
                name: "IX_Rankings_ContestId_Rank",
                table: "Rankings",
                columns: new[] { "ContestId", "Rank" });

            migrationBuilder.CreateIndex(
                name: "IX_Rankings_ContestId_TotalScore_PenaltyTime",
                table: "Rankings",
                columns: new[] { "ContestId", "TotalScore", "PenaltyTime" });

            migrationBuilder.CreateIndex(
                name: "IX_Rankings_ContestId_UserId",
                table: "Rankings",
                columns: new[] { "ContestId", "UserId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubmissionResults_SubmissionId_TestCaseId",
